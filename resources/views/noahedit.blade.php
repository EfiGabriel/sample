...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    ...
    <form action="{{route('sample.update',$datas->id)}}" method="POST">
        @csrf
        @method('PUT')
    <div class="row">
        <div class="col-sm-12 col-md-4">
            <label>Plant/Depot No.</label>
            <select class="form-control" option="{{$datas->Depot}}" id="exampleFormControlSelect1" name="Depot">
                <option value="{{$datas->Depot}}">{{$datas->Depot}}</option>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-4">
            ...
            <select class="form-control" id="exampleFormControlSelect1" name="SBU">
                <option value ="{{$datas->SBU}}">{{$datas->SBU}}</option>
                <option>JB</option>
                <option>CK</option>
                <option>MI</option>
                <option>RR</option>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-4">
            ...
            <select class="form-control" id="itemSelect" name="Item">
                <option value="{{$datas->Item}}">{{$datas->Item}}</option>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-4">
            ...
            <input type="text" value = "{{$datas->Pallet}}"class="form-control" placeholder="# of Pallet Used" name="Pallet">
        </div>
    </div>
    <br>
    <div class="row">
        <div class="col-sm-12 col-md-4">
            ...
            <input type="text" class="form-control" placeholder="SAP Inventory  Balance" name="TP" value="{{$datas->TP}}">
        </div>
        <div class="col-sm-12 col-md-4">
            <label>Actual Balance</label>
            <input type="text" class="form-control" placeholder="Actual Balance" name="Actual" value="{{$datas->Actual}}">
        </div>
    </div>
    <br>
    <br>
